...
const Header = () => {
  ...
  return (
  <AppBar position="sticky" sx={{background:"linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(161,98,238,1) 43%, rgba(163,107,240,1) 50%, rgba(178,171,255,1) 100%, rgba(136,104,255,1) 100%)"}}>
    <Toolbar>
